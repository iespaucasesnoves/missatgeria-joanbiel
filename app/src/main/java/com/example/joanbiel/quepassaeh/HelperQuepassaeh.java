...
public class HelperQuepassaeh extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_CREATE_MISSATGE = "create table " + TABLE_MISSATGE + "("
            + COLUMN_CODI+ " integer primary key, "
    ...
    private static final String DATABASE_CREATE_USUARI = "create table "+ TABLE_USUARI + "("
            + COLUMN_CODIUSUARI + " integer primary key, "
